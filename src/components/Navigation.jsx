...
export function Sidebar({ user, current, onNavigate, onLogout }) {
  ...
  return (
    <>
      {/* Mobile Top App Bar: Hamburger on Left */}
        ...
        {mobileOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 flex w-3/4 max-w-xs flex-col border-r border-white/10 bg-background/95 p-4 shadow-2xl backdrop-blur-xl"
            >
